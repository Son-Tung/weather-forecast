          ...
          <div className='more-detail-display active'>
            ...
            <div className="weather-info">
              ...
              <div className="weather-details">
                <div><MapPin className="weather-icon" /> <strong>Location:</strong> {weatherData.name}, {weatherData.sys.country}</div>
                <div><MapPin className="weather-icon" /> <strong>Coordinates:</strong> {weatherData.coord.lat}, {weatherData.coord.lon}</div>
                <div><Thermometer className="weather-icon" /> <strong>Temperature:</strong> {weatherData.main.temp}°C</div>
                <div><Thermometer className="weather-icon" /> <strong>Feels Like:</strong> {weatherData.main.feels_like}°C</div>
                <div><Thermometer className="weather-icon" /> <strong>Min Temperature:</strong> {weatherData.main.temp_min}°C</div>
                <div><Thermometer className="weather-icon" /> <strong>Max Temperature:</strong> {weatherData.main.temp_max}°C</div>
                <div><Droplet className="weather-icon" /> <strong>Pressure:</strong> {weatherData.main.pressure} hPa</div>
                <div><Droplet className="weather-icon" /> <strong>Humidity:</strong> {weatherData.main.humidity}%</div>
                <div><Eye className="weather-icon" /> <strong>Visibility:</strong> {weatherData.visibility} m</div>
                <div><Wind className="weather-icon" /> <strong>Wind Speed:</strong> {weatherData.wind.speed} m/s</div>
                <div><Wind className="weather-icon" /> <strong>Wind Direction:</strong> {weatherData.wind.deg}°</div>
                <div><Cloud className="weather-icon" /> <strong>Clouds:</strong> {weatherData.clouds.all}%</div>
